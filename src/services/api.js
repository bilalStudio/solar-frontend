...
export const uploadAPI = {
  // dataType examples: SOLAR_ACTUAL, SOLAR_ESTIMATED, CLEANING_BEFORE, CLEANING_AFTER, SYSTEM
  uploadExcel: (file, customerId, dataType = 'SYSTEM') => {
...
export const reportAPI = {
  ...
  email:            (reportId, data)     => api.post(`/api/reports/email/${reportId}`, data, { timeout: 60000 }),
